export const PROJECT_TITLE = "celo-donate-v1";
export const PROJECT_DESCRIPTION = "Support our community with USDC donations. Quick, easy, and secure payments on Base.";
